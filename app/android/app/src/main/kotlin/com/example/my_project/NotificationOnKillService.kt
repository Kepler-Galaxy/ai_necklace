package com.keplergalaxy.necklace
...
class NotificationOnKillService: Service() {
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        try {
            ...
            val notificationBuilder = NotificationCompat.Builder(this, "com.keplergalaxy.necklace")
            ...
            val channel = NotificationChannel("com.keplergalaxy.necklace", name, importance).apply {
