      ...
      child: Scaffold(
        ...
        body: ListView(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Text('2. Where do you plan to use your Friend?',
                  style: Theme.of(context).textTheme.titleLarge),
            ),
            const SizedBox(height: 16),
            for (var i = 0; i < options2.length; i++)
              RadioListTile<String>(
                title: Text(options2[i],
                    style: Theme.of(context).textTheme.titleMedium),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Text('3. What\'s your age range?',
                  style: Theme.of(context).textTheme.titleLarge),
            ),
            const SizedBox(height: 16),
                ...
                onPressed: () {
                  if (selectedProfession != null &&
                    ...
                    MixpanelManager().setUserProperties(
                        selectedProfession!, selectedUsage!, selectedAge!);
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                        builder: (c) =>
                            const SpeechProfilePage(onbording: true)));
                  } else {
